...
function createBookCard(book) {
  ...
  card.innerHTML = `
    <div class="card shadow-sm"  style="background-color:green;">
      ...
      <div class="card-body">
          ...
          <button class="btn btn-sm ${book.favorite ? "btn-warning" : "btn btn-secondary"}" onclick="toggleFavorite('${book.id}')">
